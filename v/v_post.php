    ...
    <?if($isAuth):?>
        <div class="row">
            <div class="column large-4 align-center">                   
                <a class="btn btn--primary h-full-width" href="index.php?c=edit&id_article=<?=$article['id_article']?>">Редактировать</a>
            </div>
            <div class="column large-4 align-center">                   
                <a class="btn btn--primary h-full-width" href="index.php?c=delete&id_article=<?=$article['id_article']?>">Удалить</a>
            </div>
        </div>
    <?endif?>
<?else:?>
